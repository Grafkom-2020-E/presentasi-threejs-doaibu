...
const main = () => {
    ...
    let matcap = new THREE.TextureLoader().load('assets/textures/matcap-porcelain-white.jpg');
    ...
    const animate = () => {
        ...
        if (controls.matcap == 0) {
            material.matcap = null;
        } else if (controls.matcap == 1) {
